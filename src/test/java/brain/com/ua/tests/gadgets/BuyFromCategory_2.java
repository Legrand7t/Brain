package brain.com.ua.tests.gadgets;
...
public class BuyFromCategory_2 extends TestInit {
    ...
    public void doIt() throws InterruptedException {
        ...
        homePage.getGadgets().click();              // переходимо у розділ "Гаджети, фото і відео"

        BrainGadgetsPage gadgetsPage = new BrainGadgetsPage(driver);
        gadgetsPage.getWearableDevices().click();   // обираємо категорію "Носимі пристрої"
        gadgetsPage.getSubFitBracelets().click();   // обираємо підкатегорію "Фітнес браслети"
        gadgetsPage.getFirstModel().click();        // обираємо першу модель
