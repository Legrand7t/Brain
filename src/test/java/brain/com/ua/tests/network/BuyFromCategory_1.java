...
public class BuyFromCategory_1 extends TestInit {
    ...
    public void doIt() throws InterruptedException {
        ...
        networkHardwarePage.getActiveNetwork().click();    // обираємо категорію "Активне мережеве"
        networkHardwarePage.getSubRouters().click();       // обираємо підкатегорію "Маршрутизатори"
